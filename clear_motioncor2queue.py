...
class Motioncor2RunnerClearQueue(CommonService):
    ...
    def initializing(self):
        ...
        self._transport.subscribe(queue_name, self.consume_message)
        # workflows.recipe.wrap_subscribe(self._transport, queue_name,
        #                                 self.consume_message, acknowledgement=True, log_extender=self.extend_log,
